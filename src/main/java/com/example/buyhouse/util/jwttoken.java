package com.example.buyhouse.util;

import com.example.buyhouse.util.SystemConstant;
import com.example.buyhouse.entity.CheckResult;
...
public class jwttoken {
    ...
    public static String createJWT(String id, String subject, long ttlMillis) {
        SignatureAlgorithm signatureAlgorithm = SignatureAlgorithm.HS256;//简单性能高
    ...
    public static SecretKey generalKey() {
        byte[] encodedKey = Base64.decode(SystemConstant.JWT_SECERT);//系统密匙解密
        SecretKey key = new SecretKeySpec(encodedKey, 0, encodedKey.length, "AES");//对称密匙规范
        return key;
    }
